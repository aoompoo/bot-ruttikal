...
RfuBot=[lineMID]
Family=["u46edcb0e45dff75ec4ae25e12d0d7eb0",lineMID]
admin = "u46edcb0e45dff75ec4ae25e12d0d7eb0" 
admin=['u46edcb0e45dff75ec4ae25e12d0d7eb0',lineMID]
...
settings = {
    ...
    "man2":"",
    "man3":"",
    "message":"บัญชีนี้ได้การป้องกันโดย @รัตติกาล ระบบได้ทำการบล็อคคุณโดยอัตโนมัติสามารถเพิ่มเพื่อนที่ไอดีไลน์ ruttikal. vip",
...
╠❋►คส8 = คสล่องหน
╠
╠❋►ใช้ให้เกิดประโยชน์ท่าเอาไป
╠❋►ทำร้ายคนอื่นโทษแบนนะคะ"""
    return myHelp

def listgrup():
    listGrup =  """►คสตั้งค่า⍣@ruttikal⍣
╔══════════════════════┓
...
╠❋►เปิดเชคติ้ก ➠เปิดดูลิ้งค์สติ้กเก้อ
╠❋►ปิดเชคติ้ก ➠ปิดดูลิ้งค์สติ้กเก้อ
╠❋►เปิดอ่าน ➠เปิดจับคนแอบอ่าน
╠❋►ปิดอ่าน ➠ปิดจับคนแอบอ่าน
╠❋►เปิดข้อมูล ➠เปิดอ่านMid  
╠❋►ปิดข้อมูล ➠ปิดอ่านMid  
╠❋►เปิดลิ้งค์ ➠เปิดดูลิ้งค์โพส
╠❋►ปิดลิ้งค์ ➠ปิดดูลิ้งค์โพส
╠❋►คสตั้งแทคตั้งเข้าตั้งออกให้เปลี่ยน
╠❋►เป็นนี้นะคะเช่น : สวัสดี
...
╠❋►คสห้ามโปร  ไว้ใช้กับคนคนเล่นบอท
╠❋►หรา @  ➠ เตะกลับแชท
╠❋►แอดมิน @  ➠ เพิ่มแอดมิน
╠❋►ลบแอดมิน @  ➠ ลบแอดมิน
╠❋►แบน @ ➠ แทคคนจะลงดำ"""
...
╠❋► กลับ  ➠ กลับร่างเดิม
╠❋► เทส  ➠ ทดสอบบอท
╠❋► เปิดหมด ➠ เปิดฟั่งชั่นป้องกันกลุ่ม
╠❋► ปิดหมด  ➠ ปิดฟังชั่งป้อวกันกลุ่ม
╠❋► sp  ➠ ทดสอบความเร็ว
╠❋► โทร  ➠ เชิญโทร
╠❋► .โทร  5 ➠ เชิญโทร
╠❋► ดูเวลา ➠ เช็ควันเวลา
...
╠❋► ปิดเวลา ➠ ปิดเวลา
╠❋► รีเวลา ➠ ลบเวลาคนอ่าน
╠❋► บล็อค. ➠ รายชื่อที่เราบ๊อคเพื่อน
╠❋► ## ข้อความ ➠ ส่งแชททุกห้อง"""
    return helpSetting

def helptexttospeech():
    helpTextToSpeech =   """❋►คสเลียนแบบ⍣@ruttikal⍣
❇ เลียนแบบ on/off 
❇ เลียนแบบ 
❇ เพิ่มเลียนแบบ (@) 
❇ ลบเลียนแบบ (@)"""
...
def helplanguange():
    helpLanguange =    """คสล่องหน⍣@ruttikal⍣
ℹ!แทค
ℹ!มิด
ℹ!คท"""
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    if targets == []:
                        line.sendMessage(to, "ℹไม่มีคนใส่ร่องหนในกลุ่มนี้ค่ะ✅")
                    else:
                        mc = ""
                        for target in targets:
                    ...
                    for g in gs.members:
                        if g.displayName in "":
                            lists.append(g.mid)
                    if lists == []:
                        line.sendMessage(to, "ℹไม่มี MID คนใส่ร่องหนค่ะ✅")
                    else:
                        mc = ""
                        for mi_d in lists:
                            mc += "->" + mi_d + "\n"
                    ...
                    ki.sendMessage(to, "บอทรัตติกาลเธอมันสวยยังอยู่ค่ะ")
                elif text.lower() == 'เทส':
                    line.sendMessage(to, "ท่าถึง100นั้นเเละความสวยรัตติกาลกำลังโหลด:▒...0%")
                    ...
                    line.sendMessage(to, " รัตติกาลคนสวยยังอยู่ค่ะ✔")
                ...
                elif "หรา " in msg.text:
                        vkick0 = msg.text.replace("หรา ","")
                    ...
                    start = time.time()
                    line.sendMessage(to,"ความเร็วของ @รัตติกาล...")
                    elapsed_time = time.time() - start
                    line.sendMessage(to,format(str(elapsed_time)))	
                elif text.lower() == 'รีบอท':
                    line.sendMessage(to, "กำลังเริ่มต้นใหม่ ... โปรดรอสักครู่ค่ะ ...")
...
#==============================================================================#
                    ...
                    try:
                        ret_ = "╔════[  สถานะ @ruttikal ]═════┓"
                        if settings["บอททำงานปกติค่ะ"] == True: ret_ += "\n╠❂☞ รับบล็อคออโต้ ✔"
                        else: ret_ += "\n╠🔀 รับบล็อคออโต้    ✘ "
                ...
                elif text.lower() == 'เปิดลิ้งค์แชร์':
                    settings["timeline"] = True
                    line.sendMessage(to, "เปิดลิ้งค์แชร์แล้ว.")
                elif text.lower() == 'ปิดลิ้งค์แชร์':
                    settings["timeline"] = False
                    line.sendMessage(to, "ปิดลิ้งค์แชร์แล้ว.")
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u46edcb0e45dff75ec4ae25e12d0d7eb0")
                elif text.lower() == 'มิด':
...
#                    line.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + me.pictureStatus)
                    ...
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        ...
                        for ls in lists:
                            contact = line.getContact(ls)
                            line.sendMessage(msg.to, "[ สถานะที่ตั้ง ]\n{}" + contact.statusMessage)
                    ...
                    try:
                        ...
                        line.sendMessage(msg.to, "กลับร่างเดิมแล้วค่ะ")
...
#==============================================================================#
                    ...
                    if mic == "on":
                        if settings["mimic"]["status"] == False:
                            ...
                            line.sendMessage(msg.to,"เปิดระบบเลียนแบบแล้วค่ะ")
                    elif mic == "off":
                        if settings["mimic"]["status"] == True:
                            settings["mimic"]["status"] = False
                            line.sendMessage(msg.to,"ปิดระบบเลียนแบบแล้วค่ะ")
#==============================================================================#
                elif text.lower() == 'แอด':
                ...
                elif text.lower() == 'ลิ้งค์':
                    if msg.toType == 2:
                        group = line.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            ticket = line.reissueGroupTicket(to)
                            line.sendMessage(to, "ลิ้งค์กลุ่ม กดลิ้งค์นี้\nhttps://line.me/R/ti/g/{}".format(str(ticket)))
                    ...
                    if LINE != None:
                         ...
                         if spl[0] == "":
                            ...
                            if msg.toType == 2:
                                ...
                                num = int(strnum)
                                line.sendMessage(to, "เชิญโทรเรียบร้อยแล้วค่ะ")
                    ...
                    line.sendMessage(msg.to,"เชิญโทรสำเร็จแล้วค่ะ")	
                elif text.lower() == 'แทก':
                            if msg.toType == 0:
                                sendMention(to, to, "", "")
                            elif msg.toType == 2:
                    ...
                    line.sendText(msg.to,"กรุณารอสักครู่ ใจเย็นๆนะคะ")
...
#==============================================================================#
                    ...
                    if msg.to in read['readPoint']:
                        ...
                        with open('read.json', 'w') as fp:
                            json.dump(read, fp, sort_keys=True, indent=4)
                            line.sendMessage(msg.to, "ตั้งเวลา:\n" + readTime)
...
#==============================================================================#   
                ...
                elif msg.text.lower() == "ลบค้างเชิญ":
                    if msg.toType == 2:
                        group = line.getGroup(msg.to)
                        gMembMids = [contact.mid for contact in group.invitee]
                        for i in gMembMids:
...
#=============COMMAND KICKER===========================#
                    ...
                    settings["blacklist"] = {}
                    line.sendMessage(msg.to,"ทำการลบบัญชีดำทั้งหมดเรียบร้อยแล้วค่ะ")
                    print ("Clear Ban")

                elif 'ห้ามโปร' in text.lower():
                       targets = []
                       key = eval(msg.contentMetadata["MENTION"])
                       key["MENTIONEES"] [0] ["M"]
                       for x in key["MENTIONEES"]:
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in bot1:
                        if settings["blacklist"] == {}:
                            ...
                            line.sendMessage(msg.to,"รอแปปค่ะกำลังเช็ค...")
                            num=1
...
#=============COMMAND PROTECT=========================#
                    ...
                    if RfuProtect["linkprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"ปิดป้องกันลิ้งค์   ")
                        else:
                            line.sendMessage(msg.to,"ปิดป้องกันลิ้งค์   ")
                    else:
...
#==============FINNISHING PROTECT========================#
                    ...
                    elapsed_time = time.time() - start
                    line.sendMessage(to, "ลบรันเสร็จแล้วค่ะ")
                      ...
                      if msg.toType == 2:
                       ...
                       for target in targets:
                           try:
                               ...
                               f=codecs.open('st2__b.json','w','utf-8')
                               json.dump(settings["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                               line.sendMessage(msg.to,"เพิ่มลงบัญชีดำเรียบร้อยค่ะ ")
                               print ("Banned User")
                           except:
                       ...
                       for target in targets:
                           try:
                               ...
                               f=codecs.open('st2__b.json','w','utf-8')
                               json.dump(settings["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                               line.sendMessage(msg.to,"แก้ดำเรียบร้อยค่ะ...")
                               print ("Unbanned User")
                           except:
                               line.sendMessage(msg.to,"ไม่พบผู้ติดต่อ")
...
#=======================================================================================
                    ...
                    if settings["changePictureProfile"] == True:
                        ...
                        line.sendMessage(to, "เปลี่ยนโปรไฟล์สำเร็จแล้วค่ะ")
                    if msg.toType == 2:
                        if to in settings["changeGroupPicture"]:
                            path = line.downloadObjectMsg(msg_id)
                            settings["changeGroupPicture"].remove(to)
                            line.updateGroupPicture(to, path)
                            line.sendMessage(to, "เปลี่ยนรูปกลุ่มสำเร็จแล้วค่ะ")
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ เลยอ่ะ👍")
                if msg.text in ["กินข้าวยัง","กินข้าวยังทุกคน","กินข้าวกันยัง","กินข้าวกันยังทุกคน","กินข้าวยังค่ะ","ทานข้าวยังค่ะ","กินข้าวยังค่ะทุกคน"]:
                    line.sendText(msg.to,"ยังเลย รอคนมาป้อนอยู่ค่ะ!!.")
                if msg.text in ["5555556","55556","555556","556+","556++","5555556+","555++","555555556+","55556++"]:
                    line.sendText(msg.to,"อิอิ😝😝")				
                if msg.text in dangerMessage:
                    random.choice(Rfu).kickoutFromGroup(receiver,[sender])
                    random.choice(Rfu).sendText(msg.to,"ตรวจพบคำสั่งของบอทลบกลุ่ม  รัตติกาล BotSelf จำเป็นต้องนำออกเพื่อความปลอดภัยของสมาชิกค่ะ")										
        if op.type == 17:
          if settings["Wc"] == True:
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['สวัสดีคนอ่านค่ะ➠','ตร๊ะ!..เอ๋!!..😝➠','แอบทำไมค่ะ..😜➠','เห็นนะ อิอิ..😝➠','แอบทำมัย? มาคุยกันหน่อย➠','แอบแฟนเล่นหราา💨➠','รู้นะว่าอ่านอยู่👉➠','เล่นซ่อนแอบหรอคร้าาาา👻➠','มาคุยกับเค้าหน่อย➠','นั่นแน่ แอบหราาา➠','จร๊ะ!!..เอ๋!..➠']
